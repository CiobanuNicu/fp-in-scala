...
class Exercise10Test extends FlatSpec with ShouldMatchers with TableDrivenPropertyChecks {
  ...
  def foldLeftSum (ns: List[Int]): Int = Exercise10.foldLeft(ns, 0)(_ + _)
  ...
  def foldLeftProduct (ds: List[Double]): Double = Exercise10.foldLeft(ds, 1.0)(_ * _)
