...
import fpInScala.exercises.Exercise3Point10

class Exercise3Point10Test extends FlatSpec with ShouldMatchers with TableDrivenPropertyChecks {
  ...
  def foldLeftSum (ns: List[Int]): Int = Exercise3Point10.foldLeft(ns, 0)(_ + _)
  ...
  def foldLeftProduct (ds: List[Double]): Double = Exercise3Point10.foldLeft(ds, 1.0)(_ * _)
