...
class Exercise3Test extends Properties("Exercise3.intDouble, Exercise3.doubleInt, Exercise3.double3") {
  property("Exercise3.intDouble produces a pair of Int and Double") = forAll { (n: Long) =>
    val rng = SimpleRNG(n)
  ...
  property("Exercise3.doubleInt produces a pair of Double and Int") = forAll { (n: Long) =>
    val rng = SimpleRNG(n)
  ...
  property("Exercise3.double3 produces a triple of Double, Double, Double") = forAll { (n: Long) =>
    val rng = SimpleRNG(n)
